...
static void * ENParentViewControllerPropertyKey = &ENParentViewControllerPropertyKey;
...
- (void)presentPopUpViewController:(UIViewController *)popupViewController parent:(UIViewController *)parentViewController
{
     self.en_parentViewController = parentViewController;
     self.en_popupViewController = popupViewController;
    [self presentPopUpView:popupViewController.view completion:nil];
//	[self presentPopUpViewController:popupViewController completion:nil];
...
- (UIViewController *)en_parentViewController
{
    return objc_getAssociatedObject(self, ENParentViewControllerPropertyKey);
}

- (void)setEn_parentViewController:(UIViewController *)en_parentViewController
{
    objc_setAssociatedObject(self, ENParentViewControllerPropertyKey, en_parentViewController, OBJC_ASSOCIATION_RETAIN);
...
- (UIView*)topView {
    ...
    UIViewController *parent = self.en_parentViewController;
