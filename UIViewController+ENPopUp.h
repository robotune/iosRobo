...
@property (nonatomic, retain) UIViewController *en_parentViewController;
...
- (void)presentPopUpViewController:(UIViewController *)popupViewController parent:(UIViewController *)parentView;
